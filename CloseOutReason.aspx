<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CloseOutReason.aspx.cs" Inherits="CTMS.CloseOutReason" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    <script type="text/javascript">
        function AddComments() {
            var Section = 'REASON FOR SITE CLOSE OUT';
            var SectionID = '5';
            var SubSectionID = '5.3';
                   ...
                   <div  class="box">
                        <asp:GridView ID="DSVISDAT" runat="server" AutoGenerateColumns="False" Name="DSVISDAT"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="REASON FOR SITE CLOSE OUT" HeaderStyle-CssClass="" ItemStyle-CssClass="align-left">
                                    <ItemTemplate>
