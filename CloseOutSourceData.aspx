<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CloseOutSourceData.aspx.cs" Inherits="CTMS.CloseOutSourceData" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    <script type="text/javascript">
        function AddComments() {
            var Section = 'SOURCE DATA (DOCUMENTS) AND ICFs';
            var SectionID = '5';
            var SubSectionID = '5.6';
                   ...
                   <div  class="box">
                        <asp:GridView ID="DSVISDAT" runat="server" AutoGenerateColumns="False" Name="DSVISDAT"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="SOURCE DATA (DOCUMENTS) AND ICFs" HeaderStyle-CssClass="" ItemStyle-CssClass="align-left">
                                    <ItemTemplate>
