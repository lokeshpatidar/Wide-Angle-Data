<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CloseOutAdverseEvents.aspx.cs" Inherits="CTMS.CloseOutAdverseEvents" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    <script type="text/javascript">
        function AddComments() {
            var Section = 'ADVERSE EVENTS / SERIOUS ADVERSE EVENTS';
            var SectionID = '5';
            var SubSectionID = '5.11';
                   ...
                   <div class="box">
                        <asp:GridView ID="DSVISDAT" runat="server" AutoGenerateColumns="False" Name="DSVISDAT"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="ADVERSE EVENTS / SERIOUS ADVERSE EVENTS" HeaderStyle-CssClass="" ItemStyle-CssClass="align-left">
                                    <ItemTemplate>
