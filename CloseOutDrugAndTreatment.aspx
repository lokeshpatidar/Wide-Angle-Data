<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CloseOutDrugAndTreatment.aspx.cs" Inherits="CTMS.CloseOutDrugAndTreatment" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    <script type="text/javascript">
        function AddComments() {
            var Section = 'STUDY DRUG AND TREATMENT ASSIGNMENT CODES';
            var SectionID = '5';
            var SubSectionID = '5.7';
                   ...
                   <div  class="box">
                        <asp:GridView ID="DSVISDAT" runat="server" AutoGenerateColumns="False" Name="DSVISDAT"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="STUDY DRUG AND TREATMENT ASSIGNMENT CODES" HeaderStyle-CssClass="" ItemStyle-CssClass="align-left">
                                    <ItemTemplate>
