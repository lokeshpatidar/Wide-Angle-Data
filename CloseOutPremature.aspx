<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CloseOutPremature.aspx.cs" Inherits="CTMS.CloseOutPremature" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    <script type="text/javascript">
        function AddComments() {
            var Section = 'PREMATURE CLOSE OUT / TERMINATION OF STUDY AT SITE';
            var SectionID = '5';
            var SubSectionID = '5.14';
                   ...
                   <div  class="box">
                        <asp:GridView ID="DSVISDAT" runat="server" AutoGenerateColumns="False" Name="DSVISDAT"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="PREMATURE CLOSE OUT / TERMINATION OF STUDY AT SITE" HeaderStyle-CssClass="" ItemStyle-CssClass="align-left">
                                    <ItemTemplate>
