<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CloseOutObligation.aspx.cs" Inherits="CTMS.CloseOutObligation" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    <script type="text/javascript">
        function AddComments() {
            var Section = 'INVESTIGATOR OBLIGATIONS / RESPONSIBILITIES';
            var SectionID = '5';
            var SubSectionID = '5.13';
                   ...
                   <div  class="box">
                        <asp:GridView ID="DSVISDAT" runat="server" AutoGenerateColumns="False" Name="DSVISDAT"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="INVESTIGATOR OBLIGATIONS / RESPONSIBILITIES" HeaderStyle-CssClass="" ItemStyle-CssClass="align-left">
                                    <ItemTemplate>
