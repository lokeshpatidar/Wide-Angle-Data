<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AdverseEventDashboard.aspx.cs" Inherits="CTMS.AdverseEventDashboard" %>
...
<script src="https://www.amcharts.com/lib/3/themes/light.js"></script>
    <script type="text/javascript">
        ...
        function PopupAeEvents(element) {
            var Event = $(element).attr('label');
            var test = "MM_PopupAeEvents.aspx?Event=" + Event;
        ...
        <asp:Label ID="lblErrorMsg" runat="server"></asp:Label>
                                                 <div class="col-lg-3 col-xs-6" style="width:20%;">
                                                    ...
                                                    <div class="inner">
                                                        ...
                                                        <asp:label id="lbltotalevent" runat="server" Font-Bold="true" label="Total no. of Events"  onclick="PopupAeEvents(this);"  Font-Size="XX-Large">
                                                        </asp:label><br />
                                                         <asp:label runat="server" Text="Total no. of Event" label="Total no. of Events"  onclick="PopupAeEvents(this);"  Font-Size="Small">    
                                                        </asp:label>
                                                        </div>
                                                    </div>
                                                        <div class="icon">
                                                    ...
                                                    <div class="inner">
                                                        <div style="text-align:center;">
                                                        <asp:label id="lbltotalse" runat="server" Font-Bold="true" Font-Size="XX-Large" label="No. of Serious Events"  onclick="PopupAeEvents(this);" >
                                                        </asp:label><br />
                                                         <asp:label runat="server" Text="No. of Serious Event" label="No. of Serious Events"  onclick="PopupAeEvents(this);"  Font-Size="Small">   
                                                        </asp:label>
                                                            </div>
                                                    </div>
                                                        <div class="icon">
                                                    ...
                                                    <div class="inner">
                                                        <div style="text-align:center;">
                                                        <asp:Label id="lblrelatedaes" runat="server" Font-Bold="true" Font-Size="XX-Large" label="No. of Related AE's"  onclick="PopupAeEvents(this);"></asp:Label><br />
                                                         <asp:label runat="server" Text="No. of Related AES" Font-Size="Small" label="No. of Related AE's"  onclick="PopupAeEvents(this);">   
                                                        </asp:label>
                                                            </div>
                                                    </div>
                                                        <div class="icon">
                                                    ...
                                                    <div class="inner">
                                                        <div style="text-align:center;">
                                                        <asp:Label id="lblsplint" runat="server" Font-Bold="true" Font-Size="XX-Large" label="Event with special interest"  onclick="PopupAeEvents(this);">
                                                        </asp:Label><br />
                                                         <asp:label runat="server" Text="Event with special interest"  label="Event with special interest"  onclick="PopupAeEvents(this);" Font-Size="Small">    
                                                        </asp:label>
                                                    </div>
                                                        </div>
                                                        <div class="icon">
    ...
    <div class="row">
                                                 <div class="col-lg-3 col-xs-6" style="width:20%;">
                                                    ...
                                                    <div class="inner">
                                                        <div style="text-align:center;">
                                                        <asp:label id="lbldeath" runat="server" Font-Bold="true" Font-Size="XX-Large"  label="No. of Deaths" onclick="PopupAeEvents(this);">
                                                        </asp:label><br />
                                                         <asp:label runat="server" Text="No. of Deaths" Font-Size="Small"  label="No. of Deaths" onclick="PopupAeEvents(this);">    
                                                        </asp:label>
                                                        </div>
                                                    </div>
                                                        <div class="icon">
                                                    ...
                                                    <div class="inner">
                                                        <div style="text-align:center;">
                                                        <asp:label id="lblinfusion" runat="server" Font-Bold="true" label="No. of Infusion Reaction"  onclick="PopupAeEvents(this);" Font-Size="XX-Large">
                                                        </asp:label><br />
                                                         <asp:label runat="server" Text="No. of Infusion Reaction" label="No. of Infusion Reaction"  onclick="PopupAeEvents(this);" Font-Size="Small">   
                                                        </asp:label>
                                                    </div>
                                                        </div>
                                                        <div class="icon">
                                                    ...
                                                    <div class="inner">
                                                        <div style="text-align:center;">
                                                        <asp:Label id="lblongoingevents" runat="server" Font-Bold="true" Font-Size="XX-Large" label="Total No. of Ongoing Event"  onclick="PopupAeEvents(this);" ></asp:Label><br />
                                                         <asp:label runat="server" Text="Total No. of Ongoing Event" label="Total No. of Ongoing Event"  onclick="PopupAeEvents(this);" Font-Size="Small">   
                                                        </asp:label>
                                                    </div>
                                                        </div>
                                                        <div class="icon">
                                                    ...
                                                    <div class="inner">
                                                        <div style="text-align:center;">
                                                        <asp:Label id="lblseverity3n4" runat="server" Font-Bold="true" label="No. of Grade4,Grade3"  onclick="PopupAeEvents(this);" Font-Size="XX-Large">
                                                        </asp:Label><br />
                                                         <asp:label runat="server" Text="No. of Grade4,Grade3" label="No. of Grade4,Grade3"  onclick="PopupAeEvents(this);" Font-Size="Small">    
                                                        </asp:label>
                                                    </div>
                                                        </div>
                                                        <div class="icon">
